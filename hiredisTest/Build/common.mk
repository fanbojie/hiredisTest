...
# compile	
$(OBJPATH)/%.o: $(SRCPATH)/%.c
	@echo "$(CC) -c $(INCS) $(CFLAGS) $(patsubst $(SRCPATH)/%, %, $<)"
	@$(CC) -c $(INCS) $(CFLAGS) $< -o $@
$(OBJPATH)/%.o: $(SRCPATH)/%.cpp
	@echo "$(CPP) -c $(INCS) $(CFLAGS) $(patsubst $(SRCPATH)/%, %, $<)"
	@$(CPP) -c $(INCS) $(CFLAGS) $< -o $@
